...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500">Mise a jour des informations de la competition.</p>
        </div>
    ...
    <section class="max-w-3xl rounded-xl bg-white p-5 shadow">
        <form method="POST" action="{{ route('competitions.update', ['competition' => $competition->id]) }}" class="grid grid-cols-1 gap-3 sm:grid-cols-2">
            @csrf
            @method('PUT')
